...
<section class="hero <?php echo is_front_page() ? 'h-[100vh]' : 'md:h-[614px] justify-center text-center'; ?> py-[160px] pt-[194px] lg:pt-[244px] lg:pb-[200px] relative flex items-center" style="background: url(<?php echo $background ?> ) no-repeat;">
