...
<section class="hero <?php echo is_front_page() ? 'h-[100vh]' : 'md:h-[614px] justify-center text-center'; ?> py-[160px] pt-[194px] lg:pt-[244px] lg:pb-[200px] relative flex items-center" style="background: url(<?php echo $background ?> ) no-repeat; background-size:cover;">
  <div id="particles-js" class="absolute top-0 left-0 right-0 bottom-0 z-[2]"></div>
  <div class="<?php echo is_front_page() ? 'container-fluid' : 'container'; ?> <?php echo is_front_page() ? 'flex px-[24px] flex-col lg:flex-row lg:justify-between xl:px-[160px]' : ''; ?>
">
