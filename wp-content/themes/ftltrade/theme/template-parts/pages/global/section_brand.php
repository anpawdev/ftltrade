...
<section class="relative mb-[66px] min-h-[400px] md:min-h-[600px] lg:min-h-[899px] flex justify-center items-center" style="background: url(<?php echo $background ?> ) center/cover no-repeat;">
