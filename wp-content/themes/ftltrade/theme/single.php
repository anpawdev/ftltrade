...
<section class="hero hero--custom md:h-[614px] py-[160px] pt-[194px] mb-[75px] lg:pt-[244px] lg:pb-[200px] relative flex justify-center items-center" style="background: url(<?php echo $background ?> ) center/cover no-repeat;">
...
<?php get_template_part('/template-parts/pages/global/section_logotypes');?>
